...
from config.llm_config import CLASSIFIER_LLM_CONFIG,SPECIALIST_LLM_CONFIG
...
request_classifier = Agent(
    ...
    generate_content_config=CLASSIFIER_LLM_CONFIG,
...
incident_support_agent = Agent(
    ...
    generate_content_config=SPECIALIST_LLM_CONFIG,
...
root_agent = Workflow(
    ...
    name="cme_support_session_router_with_config",
